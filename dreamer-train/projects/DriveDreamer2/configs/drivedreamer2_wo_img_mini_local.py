...
exp_dir = '/data/projects/DriveLoop/exp'  # PATH TO YOUR EXPERIMENT FOLDER
...
weight_path = '/data/projects/DriveLoop/pretrained_models/drivedreamer2_wo_img/pytorch_gligen_weights.bin' # PATH TO YOUR MODEL 
# set None to load the latest checkpoint in your project_dir

save_path = '/data/projects/DriveLoop/outputs/drivedreamer2_wo_img_mini' # PATH FOR SAVING GENERATED VIDEO
...
config = dict(
    ...
    models=dict(
        pretrained='/data/projects/DriveLoop/hf_cache/stable-video-diffusion-img2vid-xt-1-1',
        text_encoder_pretrained='/data/projects/DriveLoop/hf_cache/transformers/models--cerspense--zeroscope_v2_576w/snapshots/6963642a64dbefa93663d1ecebb4ceda2d9ecb28',
