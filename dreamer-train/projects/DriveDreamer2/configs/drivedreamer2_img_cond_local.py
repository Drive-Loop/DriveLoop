...
train_data = '/data/projects/DriveLoop/data/processed/nuscenes/cam_all_train/v0.0.2'
test_data = '/data/projects/DriveLoop/data/processed/nuscenes/cam_all_val/v0.0.2'
...
save_path = '/data/projects/DriveLoop/outputs/drivedreamer2_img_cond' # PATH FOR SAVING GENERATED VIDEO
