"""Re-run the six-window pool closed-loop under the fixed protocol (v10e):
...
RUNS = [
    ("candidate1677", "experiments/manifests/v10_truck.json", "truck_cut_in_v10e"),
    ("candidate1313", "experiments/manifests/v10_night_truck.json", "night_truck_v10e"),
    ("candidate2751", "experiments/manifests/v10_rain_truck.json", "rain_truck_v10e"),
    ("candidate1300", "experiments/manifests/v10_night.json", "night_cut_in_v10e"),
    ("candidate28", "experiments/manifests/v10_bus.json", "bus_v10e"),
    ("candidate41", "experiments/manifests/v10_bicycle.json", "bicycle_v10e"),
]
