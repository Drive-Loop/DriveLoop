...
def build_candidate70_readiness_gate(
    *,
    ...
    accepted_count = prompt_bank.get("accepted_for_generate_count")
    ...
    checks = {
        ...
        "accepted_prompt_selected": bool(accepted_count and accepted_count > 0),
    ...
    return {
        ...
        "next_required_steps": [
            "select a user-confirmed accepted prompt from candidate70-supported prompt bank entries",
